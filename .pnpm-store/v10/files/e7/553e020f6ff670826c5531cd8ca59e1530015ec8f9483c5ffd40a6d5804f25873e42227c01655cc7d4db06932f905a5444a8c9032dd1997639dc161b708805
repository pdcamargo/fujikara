 ...
 */
export function getMDXComponent(code: string, jsxGlobals: Record<string, unknown>, globals?: Record<string, unknown> | undefined): (props: MDXContentProps) => JSX.Element;
export function getMDXExport(code: string, jsxGlobals: Record<string, unknown>, globals?: Record<string, unknown> | undefined): ReturnType<import("../types").MDXExport<ExportedObject, Frontmatter>>;
